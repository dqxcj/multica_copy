...
type (
	...
	PendingConfigRead       = protocol.DaemonHeartbeatPendingConfigRead
	PendingConfigWrite      = protocol.DaemonHeartbeatPendingConfigWrite
)
...
// ReportConfigReadResult posts the config read result to the server.
...
// ReportConfigWriteResult posts the config write result to the server.
